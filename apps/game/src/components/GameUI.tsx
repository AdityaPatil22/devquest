...
import {
  useGameUI,
} from '../state/GameUIContext';

import { HUD } from './HUD/HUD';

import {
  InteractionPrompt,
} from './InteractionPrompt/InteractionPrompt';

import {
  ElevatorModal,
} from './ElevatorModal/ElevatorModal';

import {
  DoorContextModal,
} from './DecisionPanel/DoorContextModal';

import {
  ChallengePanel,
} from './ChallengePanel/ChallengePanel';

import {
  EvaluationPanel,
} from './EvaluationPanel/EvaluationPanel';

import {
  WaitingOverlay,
} from './WaitingOverlay/WaitingOverlay';

import {
  TrophyScreen,
} from './TrophyScreen/TrophyScreen';
      ...
      switch (event.type) {
        ...
        case 'EVALUATION':
          setState((previous) => ({
            ...
            feedback:
              typeof event.feedback ===
              'string'
                ? event.feedback
                : undefined,

            consequence:
              typeof event.consequence ===
              'string'
                ? event.consequence
                : undefined,
