...
export function TrophyScreen({ summary, docContent, onRestart }: Props) {
  ...
  return (
    <div className="trophy-screen">
      <section className="trophy-card">
        ...
        <div className="modal-eyebrow">QUEST COMPLETE</div>

        <h1>Decision defended.</h1>

        {summary && <p className="trophy-summary">{summary}</p>}
